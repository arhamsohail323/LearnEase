...
const Resources = () => {
  ...
  return (
    <div className='m-5 p-5'>
      ...
      <div className='my-5'>
      <div className='rounded text-2xl font-semibold pb-2 text-PrimaryColor'>Assignments Outline</div>
        <ClientDatatable searchTerm={searchTerm} selectedCategory={selectedCategory} /> 
        <div className='rounded text-2xl font-semibold pb-2 text-PrimaryColor'>Lectures Notes</div> 
        <ClientDatatable searchTerm={searchTerm} selectedCategory={selectedCategory} /> 
        <div className='rounded text-2xl font-semibold pb-2 text-PrimaryColor'>TextBook MarketPlace</div> 
        <ClientDatatable searchTerm={searchTerm} selectedCategory={selectedCategory} />  
      </div>
    </div>
  );
